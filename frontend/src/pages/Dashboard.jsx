...
import { FileText, UtensilsCrossed, Mic, Activity, Users, Clock, AlertTriangle, TrendingUp, Heart, Stethoscope } from 'lucide-react'
import { useNavigate } from 'react-router-dom'

const quickActions = [
    { icon: FileText, label: 'Scan Report', path: '/report', color: '#06b6d4' },
    { icon: UtensilsCrossed, label: 'Meal Scanner', path: '/meal', color: '#10b981' },
